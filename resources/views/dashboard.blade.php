        ...
        @if (Auth::user()->role == 'staff')
            <div class="container d-flex">
                ...
                <div class="card p-4 m-3" style="width: 400px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    ...
                    <h2><i class="fa-solid fa-envelope"></i> {{ $allClassificate }}</h2>
                </div><br>
            </div>
            <div class="container d-flex">
                <div class="card p-4 m-3" style="width: 400px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <h5>Staff Tata Usaha</h5><br>
                    <h2><i class="fa-solid fa-circle-user"></i> {{ $usersStaff }}</h2>
                </div>
                <div class="card p-4 m-3" style="width: 700px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <h5>Guru</h5><br>
                    <h2><i class="fa-solid fa-circle-user"></i> {{ $usersGuru }}</h2>
                </div>
            </div>
        @endif
